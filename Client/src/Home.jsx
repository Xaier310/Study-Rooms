          ...
          <div className="navbar">
            <div className="navbar-child-1">
              <div className="navbar-logo">
                ...
                <h4 className="navbar-logo-text" data-aos="fade-zoom-in">
                  StudyRooms
                </h4>
              </div>
            ...
            <div className="navbar-child-2">
              ...
              >
                {!isLoggedIn ? "Create Account" : "Log Out"}
              </button>
            </div>
          </div>
        </header>
          ...
          <section className="main-part-1">
            <div className="main-part-1-left">
              ...
              <div className="main-part-1-left-buttons">
                ...
                <button className="main-part-1-left-buttons-button-2 main-part-1-left-buttons-button-cc">
                  <i class="fas fa-home"></i>Enter in a Room
                </button>
              </div>
            </div>
              ...
              {(isML || isWD || isAD) && (
                <div className="no-of-rooms">
                  <div className="no-of-rooms-row">
                    {popupItems}
                    <span className="no-of-rooms-row-room-cc">
